...
public final class JsonUtils {
    ...
    final static String BASE_JSON = "{\"sandwichDetails\":" +
    ...
    public static ArrayList parseSandwichJson(String json){
        ...
        try {
            ...
            JSONArray ja = jo.getJSONArray("sandwichDetails");
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                JSONObject name = jo1.getJSONObject("name");
                ...
                JSONArray ja1 = name.optJSONArray("alsoKnownAs");

                for (int k = 0; k < ja1.length(); k++) {

                    alsoKnownAsList.add(ja1.get(k).toString());
                }
                ...
                JSONArray ja2 = name.optJSONArray("ingredients");
                for (int l = 0; l < ja2.length(); l++) {

                    ingredientsList.add(ja2.get(l).toString());
                }
